...
const Flags = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <h1 className="text-3xl font-bold mb-6">Drapeaux Publicitaires</h1>
      <p className="text-gray-600 mb-8">
        Découvrez notre collection de drapeaux publicitaires personnalisables pour votre entreprise.
      </p>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {flagProducts.map((product) => (
