  ...
  return (
    <section className="py-6 lg:py-12 bg-gray-50">
      <div className="max-w-[1536px] mx-auto w-full">
        <div className="w-[91%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Location Card */}
          <div className="flex flex-col">
            ...
            <a href={location1URL} target="_blank" rel="noopener noreferrer" className="flex-1">
              <div className="relative overflow-hidden rounded-lg h-[470px] group hover:shadow-lg transition-all">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 p-3 text-white bg-[#591C1C]/80 backdrop-blur-sm">
          ...
          <div className="flex flex-col">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-5 flex items-center justify-center flex-1 shadow-lg">
              {showThankYou ? (
                ...
                <form onSubmit={handleSubmitReview} className="w-full space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#591C1C]/90 hover:bg-[#591C1C] text-white px-6 py-3 rounded-xl
